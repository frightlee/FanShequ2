...
class HaveJoinedActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        tv_year.setOnClickListener {
            ssp = SpinerPopWindow(this@HaveJoinedActivity, getYears(), AdapterView.OnItemClickListener { parent, view, position, id ->
                year = years!![position]
                getData(year,month)
                tv_year.text = year + "年"
                ssp!!.dismiss()
        ...
        tv_month.setOnClickListener {
            ssp = SpinerPopWindow(this@HaveJoinedActivity, getMonth(), AdapterView.OnItemClickListener { parent, view, position, id ->
