        ...
        x.http().post(params, object : Callback.CommonCallback<String> {
            ...
            override fun onSuccess(result: String?) {
                if (JsonSyncUtils.getJsonValue(result!!, "cw") == "0") {
                    ...
                    ssp = SpinerPopWindow(this@EditAddressActivity, cellNames!!, AdapterView.OnItemClickListener { parent, view, position, id ->
        ...
        x.http().post(params, object : Callback.CommonCallback<String> {
            ...
            override fun onSuccess(result: String?) {
                if (JsonSyncUtils.getJsonValue(result!!, "state") == "200") {
                    ...
                    ssp = SpinerPopWindow(this@EditAddressActivity, louNames!!, AdapterView.OnItemClickListener { parent, view, position, id ->
